...
The look is the realm eternal: a cosmic starfield (`stars.svg`), polished
Asgardian **gold** (`--gold`, `--gold-metal`) on the wordmark, eyebrows and
links, a slowly turning Elder-Futhark **rune ring** in the hero, and the
**Bifröst** — the rainbow bridge Heimdal guards — carried by the Æ and split
one-hue-per-app across the products.
...
- Three webfonts loaded from Google Fonts (Space Grotesk, JetBrains Mono, Noto Sans Runic)
